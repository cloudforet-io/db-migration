...
@print_log
def inventory_cloud_service_query_set_change_keys_to_data_keys(
    mongo_client: MongoCustomClient,
):
    cloud_service_query_sets = mongo_client.find(
        "INVENTORY", "cloud_service_query_set", {}, {"_id": 1, "keys": 1}
    )
